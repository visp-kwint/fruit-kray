...
const CreateReviewSchema = zod_1.z.object({
    productId: zod_1.z.string().min(1, 'Укажите товар'),
    orderId: zod_1.z.string().min(1, 'Укажите заказ'),
    rating: zod_1.z.coerce.number().int().min(1).max(5, 'Рейтинг от 1 до 5'),
    comment: zod_1.z.string().min(1, 'Напишите текст отзыва').max(1000, 'Максимум 1000 символов'),
});
